...
let tasks = {
  ...
  necromancer: new Task("necromancer", "Necromancer", -1, 116000, [{id: "skull", count: 1}, {id: "wizard", count: 1}]),
  ...
  abuse: new Task("abuse", "Abuse", -1, 102000, [{id: "alcoholic", count: 1}, {id: "children", count: 1}]),
  ...
  knight: new Task("knight", "Knight", -1, 180000, [{id: "armor", count: 1}, {id: "warrior", count: 1}]),
  hero: new Task("hero", "Hero", -1, 193000, [{id: "knight", count: 1}, {id: "dragon", count: 1}, {id: "light", count: 1}]),
  ...
  car: new Task("car", "Car", -1, 173000, [{id: "engine", count: 1}, {id: "cart", count: 1}, {id: "lamp", count: 1}, {id: "chair", count: 1}]),
  wing: new Task("wing", "Wing", -1, 13000, [{id: "air", count: 1}, {id: "mechanism", count: 1}]),
  airplane: new Task("airplane", "Airplane", -1, 196000, [{id: "car", count: 1}, {id: "wing", count: 1}, {id: "circuit", count: 1}]),
  airport: new Task("airport", "Airport", -1, 245000, [{id: "airplane", count: 1}, {id: "building", count: 1}]),
  teacher: new Task("teacher", "Teacher", -1, 69000, [{id: "student", count: 1}, {id: "time", count: 1}]),
  student: new Task("student", "Student", -1, 60000, [{id: "human", count: 1}, {id: "curiosity", count: 1}]),
  school: new Task("school", "School", -1, 263000, [{id: "building", count: 1}, {id: "teacher", count: 1}, {id: "student", count: 1}, {id: "book", count: 1}]),
  ...
  book: new Task("book", "Book", -1, 87000, [{id: "feather", count: 1}, {id: "paper", count: 1}]),
  ...
  wine: new Task("wine", "Wine", -1, 32000, [{id: "grape", count: 1}, {id: "time", count: 1}]),
  ...
  bar: new Task("bar", "Bar", -1, 145000, [{id: "alcoholic", count: 1}, {id: "vodka", count: 1}, {id: "beer", count: 1}, {id: "alcohol", count: 1}, {id: "wine", count: 1}, {id: "building", count: 1}]),
  building: new Task("building", "Building", -1, 50000, [{id: "bricks", count: 1}, {id: "concrete", count: 1}, {id: "hut", count: 1}]),
  family: new Task("family", "Family", -1, 156000, [{id: "love", count: 1}, {id: "human", count: 2}, {id: "children", count: 1}]),
  house: new Task("house", "House", -1, 246000, [{id: "love", count: 1}, {id: "building", count: 1}, {id: "family", count: 1}]),
  skyscraper: new Task("skyscraper", "Skyscraper", -1, 55000, [{id: "building", count: 1}, {id: "glass", count: 1}]),
  ...
  lamp: new Task("lamp", "Lamp", -1, 13000, [{id: "electricity", count: 1}, {id: "glass", count: 1}]),
  ...
  scientist: new Task("scientist", "Scientist", -1, 51000, [{id: "human", count: 1}, {id: "science", count: 1}]),
  ...
  solarpanel: new Task("solarpanel", "Solarpanel", -1, 17000, [{id: "glass", count: 1}, {id: "circuit", count: 1}]),
  ...
  computer: new Task("computer", "Computer", -1, 35000, [{id: "processor", count: 1}, {id: "lamp", count: 1}]),
  internet: new Task("internet", "Internet", -1, 135000, [{id: "science", count: 1}, {id: "computer", count: 2}, {id: "human", count: 2}]),
  camera: new Task("camera", "Camera", -1, 29000, [{id: "mechanism", count: 1}, {id: "lense", count: 1}, {id: "lamp", count: 1}]),
  video: new Task("video", "Video", -1, 40000, [{id: "mechanism", count: 1}, {id: "camera", count: 1}]),
  porn: new Task("porn", "Porn", -1, 72000, [{id: "sex", count: 1}, {id: "video", count: 1}]),
  pornhub: new Task("pornhub", "Pornhub", -1, 206000, [{id: "porn", count: 1}, {id: "internet", count: 1}]),
  boredom: new Task("boredom", "Boredom", -1, 62000, [{id: "human", count: 1}, {id: "time", count: 5}]),
  memes: new Task("memes", "Memes", -1, 196000, [{id: "internet", count: 1}, {id: "boredom", count: 1}]),
  fiberoptics: new Task("fiberoptics", "FiberOptics", -1, 152000, [{id: "light", count: 1}, {id: "circuit", count: 1}, {id: "glass", count: 1}, {id: "internet", count: 1}]),
  youtube: new Task("youtube", "Youtube", -1, 183000, [{id: "video", count: 1}, {id: "time", count: 1}, {id: "internet", count: 1}]),
  reddit: new Task("reddit", "Reddit", -1, 185000, [{id: "love", count: 1}, {id: "time", count: 1}, {id: "internet", count: 1}]),
  curiosity: new Task("curiosity", "Curiosity", -1, 44000, [{id: "time", count: 3}, {id: "human", count: 1}]),
  google: new Task("google", "Google", -1, 178000, [{id: "curiosity", count: 1}, {id: "internet", count: 1}]),
  hydrazine: new Task("hydrazine", "Hydrazine", -1, 15000, [{id: "gasoline", count: 1}, {id: "water", count: 1}]),
  rocket: new Task("rocket", "Rocket", -1, 210000, [{id: "hydrazine", count: 1}, {id: "airplane", count: 1}]),
  satellite: new Task("satellite", "Satellite", -1, 269000, [{id: "solarpanel", count: 1}, {id: "telescope", count: 1}, {id: "rocket", count: 1}, {id: "computer", count: 1}]),
  space: new Task("space", "Space", -1, 226000, [{id: "rocket", count: 1}, {id: "human", count: 1}]),
  moon: new Task("moon", "Moon", -1, 293000, [{id: "space", count: 1}, {id: "flag", count: 1}]),
  flag: new Task("flag", "Flag", -1, 68000, [{id: "fabric", count: 1}, {id: "metal", count: 1}]),
  rover: new Task("rover", "Rover", -1, 690000, [{id: "car", count: 1}, {id: "space", count: 1}, {id: "moon", count: 1}]),
  pillage: new Task("pillage", "Pillage", -1, 436000, [{id: "flag", count: 1}, {id: "village", count: 1}, {id: "army", count: 1}]),
  conquer: new Task("conquer", "Conquer", -1, 476000, [{id: "pillage", count: 1}, {id: "blood", count: 1}]),
  blood: new Task("blood", "Blood", -1, 41000, [{id: "human", count: 1}, {id: "weapon", count: 1}]),
  frontier: new Task("frontier", "Frontier", -1, 661000, [{id: "pillage", count: 1}, {id: "space", count: 1}]),
  ...
  anime: new Task("anime", "Anime", -1, 83000, [{id: "time", count: 1}, {id: "video", count: 1}, {id: "paper", count: 1}]),
  monk: new Task("monk", "Monk", -1, 51000, [{id: "human", count: 1}, {id: "intellect", count: 1}, {id: "time", count: 1}]),
  watch: new Task("watch", "Watch", -1, 25000, [{id: "time", count: 1}, {id: "crystal", count: 1}, {id: "circuit", count: 1}]),
  ...
  colony: new Task("colony", "Colony", -1, 294000, [{id: "tribe", count: 1}, {id: "house", count: 1}]),
  army: new Task("army", "Army", -1, 257000, [{id: "warrior", count: 1}, {id: "hero", count: 1}]),
  king: new Task("king", "King", -1, 341000, [{id: "hero", count: 1}, {id: "royalty", count: 1}]),
  ...
  empire: new Task("empire", "Empire", -1, 1109000, [{id: "conquer", count: 1}, {id: "colony", count: 1}, {id: "king", count: 1}]),
  ...
  hair: new Task("hair", "Hair", -1, 109000, [{id: "human", count: 1}, {id: "time", count: 1}, {id: "string", count: 1}]),
  string: new Task("string", "String", -1, 84000, [{id: "fabric", count: 1}, {id: "tools", count: 1}]),
  city: new Task("city", "City", -1, 832000, [{id: "building", count: 2}, {id: "school", count: 1}, {id: "skyscraper", count: 1}, {id: "car", count: 1}, {id: "house", count: 1}]),
  ...
  theft: new Task("theft", "Theft", -1, 133000, [{id: "human", count: 1}, {id: "money", count: 1}]),
  depression: new Task("depression", "Depression", -1, 236000, [{id: "family", count: 1}, {id: "corpse", count: 1}]),
  bandage: new Task("bandage", "Bandage", -1, 104000, [{id: "fabric", count: 1}, {id: "blood", count: 1}]),
  nurse: new Task("nurse", "Nurse", -1, 161000, [{id: "human", count: 1}, {id: "love", count: 1}, {id: "bandage", count: 1}]),
  doctor: new Task("doctor", "Doctor", -1, 154000, [{id: "human", count: 1}, {id: "science", count: 1}, {id: "bandage", count: 1}]),
  lust: new Task("lust", "Lust", -1, 225000, [{id: "sex", count: 7}]),
  gluttony: new Task("gluttony", "Gluttony", -1, 302000, [{id: "meat", count: 7}]),
  greed: new Task("greed", "Greed", -1, 813000, [{id: "money", count: 7}]),
  sloth: new Task("sloth", "Sloth", -1, 1065000, [{id: "sleep", count: 7}]),
  wrath: new Task("wrath", "Wrath", -1, 393000, [{id: "vampire", count: 7}]),
  envy: new Task("envy", "Envy", -1, 925000, [{id: "theft", count: 7}]),
  pride: new Task("pride", "Pride", -1, 141000, [{id: "ego", count: 7}]),
  chastity: new Task("chastity", "Chastity", -1, 414000, [{id: "student", count: 7}]),
  abstinence: new Task("abstinence", "Abstinence", -1, 575000, [{id: "children", count: 7}]),
  liberality: new Task("liberality", "Liberality", -1, 1121000, [{id: "nurse", count: 7}]),
  diligence: new Task("diligence", "Diligence", -1, 1072000, [{id: "doctor", count: 7}]),
  patience: new Task("patience", "Patience", -1, 351000, [{id: "monk", count: 7}]),
  kindness: new Task("kindness", "Kindness", -1, 1121000, [{id: "nurse", count: 7}]),
  humility: new Task("humility", "Humility", -1, 1254000, [{id: "knight", count: 7}]),
  jake: new Task("jake", "Jake", -1, 362000, [{id: "ego", count: 1}, {id: "love", count: 1}, {id: "hero", count: 1}, {id: "hair", count: 1}]),
  david: new Task("david", "David", -1, 332000, [{id: "memes", count: 1}, {id: "teacher", count: 1}, {id: "science", count: 1}, {id: "computer", count: 1}]),
  noah: new Task("noah", "Noah", -1, 479000, [{id: "sleep", count: 1}, {id: "depression", count: 1}, {id: "student", count: 1}, {id: "sex", count: 1}]),
  isaac: new Task("isaac", "Isaac", -1, 409000, [{id: "reddit", count: 1}, {id: "computer", count: 1}, {id: "anime", count: 1}, {id: "hair", count: 1}]),
  ...
  farmer: new Task("farmer", "Farmer", 1, 149000, [{id: "science", count: 1}, {id: "tools", count: 1}, {id: "tree", count: 1}, {id: "animal", count: 1}, {id: "seeds", count: 2}, {id: "beaker", count: 1}]),
  timekeeper: new Task("timekeeper", "Timekeeper", 1, 121000, [{id: "magic", count: 1}, {id: "wizard", count: 1}, {id: "time", count: 2}, {id: "sand", count: 2}, {id: "blood", count: 1}]),
  ...
  provider: new Task("provider", "Provider", 1, 340000, [{id: "internet", count: 1}, {id: "skyscraper", count: 1}, {id: "fiberoptics", count: 1}]),
  constructor: new Task("constructor", "Constructor", 1, 119000, [{id: "mechanism", count: 1}, {id: "building", count: 1}, {id: "cement", count: 1}, {id: "tools", count: 1}, {id: "human", count: 1}]),
  researcher: new Task("researcher", "Researcher", 1, 273000, [{id: "scientist", count: 1}, {id: "book", count: 1}, {id: "curiosity", count: 1}, {id: "tools", count: 1}, {id: "beaker", count: 1}, {id: "science", count: 1}]),
  trainer: new Task("trainer", "Trainer", 1, 169000, [{id: "teacher", count: 1}, {id: "warrior", count: 1}, {id: "tools", count: 1}, {id: "human", count: 1}]),
  engineer: new Task("engineer", "Engineer", 1, 93000, [{id: "scientist", count: 1}, {id: "tools", count: 1}, {id: "mechanism", count: 1}, {id: "circuit", count: 1}]),
  ...
  upgrade_farmer: new Task("upgrade_farmer", "Farm Plants", -1, 111750, [{id: "farmer", count: 0}, {id: "earth", count: 43}, {id: "fire", count: 30}, {id: "water", count: 44}, {id: "air", count: 16}, {id: "light", count: 16}], 0, [{id: "upgrade_farmer", count: -1}, {id: "seeds", count: 5}, {id: "tree", count: 5}, {id: "animal", count: 2}]),
  upgrade_timekeeper: new Task("upgrade_timekeeper", "Rewind Time", -1, 54000, [{id: "timekeeper", count: 0}, {id: "earth", count: 10}, {id: "fire", count: 15}, {id: "water", count: 20}], 0, [{id: "upgrade_timekeeper", count: -1}, {id: "time", count: 5}]),
  upgrade_smither: new Task("upgrade_smither", "Smith Tools", -1, 150000, [{id: "smither", count: 0}, {id: "earth", count: 60}, {id: "water", count: 50}, {id: "fire", count: 50}, {id: "air", count: 20}, {id: "light", count: 20}], 0, [{id: "upgrade_smither", count: -1}, {id: "tools", count: 10}]),
  upgrade_provider: new Task("upgrade_provider", "Provide Internet", -1, 100500, [{id: "provider", count: 0}, {id: "earth", count: 31}, {id: "water", count: 34}, {id: "fire", count: 45}, {id: "air", count: 12}, {id: "light", count: 12}], 0, [{id: "upgrade_provider", count: -1}, {id: "internet", count: 1}]),
  upgrade_constructor: new Task("upgrade_constructor", "Construct Buildings", -1, 73500, [{id: "constructor", count: 0}, {id: "earth", count: 28}, {id: "water", count: 34}, {id: "fire", count: 20}, {id: "air", count: 6}, {id: "light", count: 10}], 0, [{id: "upgrade_constructor", count: -1}, {id: "building", count: 2}]),
  upgrade_researcher: new Task("upgrade_researcher", "Research Science", -1, 127500, [{id: "researcher", count: 0}, {id: "earth", count: 45}, {id: "water", count: 60}, {id: "fire", count: 45}, {id: "air", count: 10}, {id: "light", count: 10}], 0, [{id: "upgrade_researcher", count: -1}, {id: "science", count: 5}]),
  upgrade_trainer: new Task("upgrade_trainer", "Train Warriors", -1, 96000, [{id: "trainer", count: 0}, {id: "earth", count: 38}, {id: "water", count: 32}, {id: "fire", count: 34}, {id: "air", count: 12}, {id: "light", count: 12}], 0, [{id: "upgrade_trainer", count: -1}, {id: "warrior", count: 2}]),
...
/* -- Things --
  ...
  Largest Tasks:
   ...
   Liberality (1120 raw, 981 steps)
   Empire (1108 raw, 970 steps)
   Diligence (1071 raw, 953 steps)
   Sloth (1064 raw, 932 steps)
   Envy (924 raw, 813 steps)
   City (831 raw, 725 steps)
   Greed (812 raw, 715 steps)
   Rover (689 raw, 614 steps)
   Frontier (660 raw, 584 steps)
 */
