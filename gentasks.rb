$things = {
  ...
  "Flower" => ["Weeds", "Seeds"],
  "Sunflower" => ["Star", "Flower"],
  "Perfume" => ["Alcohol", "Flower"],
  "Bee" => ["Flower", "Beetle"],
  "Rose" => ["Blood", "Flower"],
  "Hydrangea" => ["Flower", "Poison"],
  "Lily" => ["Water", "Flower"],
  "Storm" => ["Energy", "Air"],
  ...
  "Sand" => ["Stone", "Water"],
  "Firefly" => ["Beetle", "Fire"],
  "Spider" => ["Beetle", "String"],
  "Scorpion" => ["Beetle", "Poison"],
  "Scarab" => ["Beetle", "Sand"],
  "Termite" => ["Beetle", "Wood"],
  "Ladybug" => ["Beetle", "Love"],
  "Egg" => ["Life", "Stone"],
  ...
  "Vampire" => ["Human", "Blood"],
  "Spice" => ["Fire", "Food"],
  "Jalapeno" => ["Spice", "Lava", "Seeds"],
  "Tortilla" => ["Flour", "Paper"],
  "Burrito" => ["Tortilla", "Jalapeno", "Meat", "Cheese"],
  "Garlic" => ["Spice", "Fruit"],
  "Tomato" => ["Fruit", "Blood"],
  "Pizza" => ["Dough", "Garlic", "Tomato", "Cheese", "Food"],
  ...
  "Waterwheel" => ["Wheel", "Water"],
  "Cart" => ["Wheel", "Wood"],
  "Locomotive" => ["Cart", "Engine"],
  "Oil" => ["Water", "Coal"],
  "Plastic" => ["Oil", "Tools"],
  "Toy" => ["Plastic", "Children"],
  "Condom" => ["Plastic", "Sex"],
  "Lego" => ["Plastic", "Bricks"],
  ...
  "rEarthPorn" => ["Reddit", "Earth", "Porn"], 
  "rFoodPorn" => ["Reddit", "Food", "Porn"], 
  "rSpacePorn" => ["Reddit", "Space", "Porn"], 
  "rPics" => ["Reddit", "Camera"],
...
$upgrades = {
  "Miner" => {
    ...
    uses: -1,
    speed: 750,
    input: what_is("Stone") * 3 + what_is("Sand") * 2,
    output: ["Stone"] * 3 + ["Sand"] * 2,
  },
  "Lumberjack" => {
  ...
  "Refinery" => {
    cost: ["Mechanism", "Science", "Oil", "Gasoline", "Tools"],
    action: "Refine Oil",
    uses: -1,
    speed: 750,
    input: what_are(["Oil", "Plastic"]) + what_is("Gasoline") * 3,
    output: ["Oil", "Plastic"] + ["Gasoline"] * 3,
  },
  "Smelter" => {
  ...
  "Chef" => {
    ...
    uses: -1,
    speed: 750,
    input: what_is("Food") * 3 + what_is("Sugar"),
    output: ["Food"] * 3 + ["Sugar"],
  },
  "Teacher" => {
  ...
  "Builder" => {
    ...
    uses: -1,
    speed: 750,
    input: what_is("Building") * 2 + what_is("Bricks"),
    output: ["Building"] * 2 + ["Bricks"],
  },
  "Voyager" => {
  ...
  "Airport" => {
    cost: ["Airplane", "Building", "Solarpanel", "Oil"],
    action: "Fly Airplanes",
    uses: -1,
    speed: 750,
    input: what_is("Airplane"),
    output: ["Airplane"],
  },
